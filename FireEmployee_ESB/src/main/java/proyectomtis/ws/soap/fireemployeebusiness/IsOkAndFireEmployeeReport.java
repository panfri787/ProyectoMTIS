...
public class IsOkAndFireEmployeeReport {
     ...
     * This getter has been renamed from isIsCompletedWithoutErrors() to getIsCompletedWithoutErrors() by cxf-xjc-boolean plugin.
     * 
     */
    public boolean getIsCompletedWithoutErrors() {
